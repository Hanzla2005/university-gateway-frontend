...
import mudassirImg from "@/assets/departments/English/mudassir.png";
import zileHumaImg from "@/assets/departments/English/zilehuma.png";
    ...
    programs: [
      {
        ...
        description: "The BS English Language and Literature programme aims to develop students’ advanced knowledge, critical understanding, and practical competence in English language and literature. The programme provides a balanced study of language, linguistics, literary texts, and critical theories, enabling students to understand how English functions as a means of communication, cultural expression, and intellectual inquiry. It seeks to enhance students’ skills in reading, writing, speaking, listening, critical thinking, research, and academic communication, while fostering creativity, analytical ability, and cultural awareness. Through engagement with diverse literary traditions and contemporary approaches to language study, the programme prepares graduates for careers in education, research, media, communication, publishing, civil services, and other professional fields, as well as for advanced study in English, linguistics, literature, applied linguistics, and related disciplines.",
        careersOverview: "Top 6 Career Opportunities",
        careers: [
          "Teaching & Higher Education – School, college, and university teaching, English language instruction, academic coordination, and research.",
          "Civil Services & Competitive Examinations – Strong preparation for CSS, PMS, and other competitive examinations and public-sector careers.",
          "Media & Journalism – Careers in print, electronic, broadcast, and digital media, including journalism, reporting, and media production.",
          "Content Writing & Publishing – Opportunities as content writers, copywriters, editors, proofreaders, technical writers, and publishing professionals.",
          "Corporate Communication & Public Relations – Careers in corporate communication, public relations, advertising, organizational communication, and professional writing.",
          "Freelancing & Digital Careers – Online teaching, academic writing, translation, editing, content creation, and other international remote-work opportunities."
        ]
      }
    ]
  },
