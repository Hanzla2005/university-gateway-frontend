                          ...
                          return (
                            ...
                            >
                              <Link
                                ...
                                className="relative flex items-center justify-center p-6 min-h-[110px] h-full bg-white border border-primary/40 hover:border-primary hover:shadow-[0_4px_15px_rgba(0,0,0,0.05)] overflow-hidden group"
                              >
                                ...
                                <h4 className="relative z-10 text-[13px] md:text-[14px] font-bold text-primary group-hover:text-white uppercase tracking-wider leading-relaxed text-center transition-colors duration-300">
                                  {dept.name}
                                </h4>
                              </Link>
                            </motion.div>
